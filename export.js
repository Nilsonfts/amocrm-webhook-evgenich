...
// --- Настройки выгрузки ---
// За все время - без ограничения по дате (как на скриншоте)
const startDate = new Date('2020-01-01'); // Максимально ранняя дата
startDate.setHours(0, 0, 0, 0);
const startTimestamp = Math.floor(startDate.getTime() / 1000);
console.log(`📅 Выгрузка ЗА ВСЕ ВРЕМЯ с ${startDate.toLocaleDateString('ru-RU')}`);
// --------------------------
